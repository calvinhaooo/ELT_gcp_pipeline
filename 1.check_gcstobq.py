...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='global_health_gcp',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='silken-champion-459110-m4.staging_gcs.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV',
